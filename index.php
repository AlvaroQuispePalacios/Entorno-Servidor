...
<div id="carouselExampleCaptions" class="carousel slide ">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./img/slider1.jpg" class="d-block w-100" style="height: 89vh;">
    ...
    <div class="carousel-item">
      <img src="./img/slider2.jpg" class="d-block w-100" style="height: 89vh;">
      <div class="carousel-caption d-none d-md-block" >
    ...
    <div class="carousel-item">
      <img src="./img/slider3.jpg" class="d-block w-100" style="height: 89vh;">
      <div class="carousel-caption d-none d-md-block">
...
<div class=" p-5">
    <div class="row mt-2">
        <div class="col-12 col-sm-12 col-md-6 index-hotel__img "></div>
        <div class="col-12 col-sm-12 col-md-6 order-0 d-flex flex-column justify-content-center align-items-center p-5 card_room_color">
            <h2 class="fw-bold">Habitaciones</h2>
            <p class="text-center card_room_text">
