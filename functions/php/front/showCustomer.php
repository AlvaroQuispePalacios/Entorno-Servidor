...
?>
    <tr>
        <td><?php echo ($dbCustomer["customer_id"]) ?></td>
        <td><?php echo ($dbCustomer["customer_name"]) ?></td>
        <td><?php echo ($dbCustomer["customer_surname"]) ?></td>
        <td><?php echo ($dbCustomer["customer_phone"]) ?></td>
        <td><?php echo ($dbCustomer["customer_email"]) ?></td>
        <td><?php echo ($dbCustomer["customer_password"]) ?></td>
        <td><?php echo ($dbCustomer["customer_rol"]) ?></td>
        <td>
            <img src="<?php print_r($dbCustomer['customer_img']) ?>" alt="img_user" width="100px" height="39px">
        </td>
