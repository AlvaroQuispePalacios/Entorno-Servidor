...
<?php
    if(isset($_POST['submit'])){
        ...
        if(isset($_FILES['file'])){
            ...
            $valid_types = array('image/jpg', 'image/webp', 'image/png', 'image/jpge');
            ...
            // Comprobar que el archivo sea jpg, webp, png, jpge y guardamos la ruta de la imagen para agregarlo a la base de datos
        ...
        VALUES
        (DEFAULT, '$room_category_name', '$room_category_price', '$room_category_description', )";
